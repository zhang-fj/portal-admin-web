<template>
  <div class="app-container" style="padding-top:15px">
    <div class="head-container">
      ...
      <curd-operation>
        <span slot="left">
          <file-upload :src-id="srcId" :type="type" @upload-success="toQuery">
...
export default {
  name: 'TopicUploadPage',
  components: { CurdOperation, Pagination, UdOperation, FileUpload },
  ...
  data() {
    return {
      defaultQuery: { type: this.type, srcId: this.srcId },
      title: '附件上传',
      api: { page, del },
      optShow: {
        add: false,
