<template>
  <div class="head-container">
    ...
    <curd-dialog :visible="dialog" :loading="submitBtnLoading" :title="title" @cancel-cu-handler="cancelCU" @submit-cu-handler="submitCU">
      <role-form ref="form" :data="formData" @submit-after-handler="submitAfterHandler" @submit-before-handler="submitBeforeHandler" @submit-error-handler="submitErrorHander" />
    </curd-dialog>
  </div>
</template>
...
import { page, del } from '@/api/bm02priv/role-api' // 导入【查询】和【删除】api
...
import roleForm from './role-form' // 导入【表单】组件

export default {
  name: 'RolePage',
  components: { CurdOperation, Pagination, RrOperation, UdOperation, CurdDialog, roleForm },
